...
public class MazeGeneration : MonoBehaviour
{
    ...
    //private static Dictionary<Vector2Int, GameObject> cellObjctsposition = new Dictionary<Vector2Int, GameObject>();
...
/*
    // Own Addition for Debug Purposes //
    public static GameObject GetCellObjectAt(Vector2Int pos)
    {
        return cellObjctsposition[pos];
    }*/
    ...
    public void GenerateMaze()
    {
        ...
        for (int x = 0; x < width; x++)
        {
            for (int y = 0; y < height; y++)
            {
                ...
                //cellObjctsposition.Add(new Vector2Int(x,y), cellObject.gameObject);
            }
        }
    }
